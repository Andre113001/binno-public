            ...
            >
              ...
              <div className="flex flex-col">
                <div className="flex flex-col">
                  ...
                  <h2 className="text-black text-opacity-80 ">
                    <CalendarMonthRoundedIcon />ㅤ{moment(event.event_date).format("MMMM DD, YYYY")}
                  </h2>
                  <h2 className="text-black text-opacity-80 mb-1">
                    <AccessTimeRoundedIcon />ㅤ{moment(event.event_time, "HH:mm:ss").format("hh:mm A")}
                  </h2>
                </div>
              ...
              <div className="flex items-center flex-row m-1 mt-3">
                ...
                />
                <h2 className="text-black mx-2 font-bold">{event.setting_institution}</h2>
              </div>
            </div>
        ))}
      </div>
